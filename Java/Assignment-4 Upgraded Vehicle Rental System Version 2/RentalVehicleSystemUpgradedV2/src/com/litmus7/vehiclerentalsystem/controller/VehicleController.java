...
public class VehicleController {
	 ...
	 */
	public Response getAllVehiclesFromFile(List<Vehicle> vehicles, String filepath) {
		...
		if (!file.canRead()) {
			response.setStatusCode(INVALID_DATA);
			response.setErrorMessage("File not readable");
			return response;
		}
	 ...
	 * @return Response to indicate the corresponding status of the the operation.
	 */
	public Response searchVehicleByBrandOrModel(List<Vehicle> vehicleList, String findVehicle) {
		Response response = new Response();
	 ...
	 * @return Response to indicate the corresponding status of the the operation.
	 */
	public Response rentVehicle(List<Vehicle> vehicleList, String model) {
		Response response = new Response();
	 ...
	 * @return Response to indicate the corresponding status of the the operation.
	 */
	public Response returnRentedVehicle(List<Vehicle> vehicleList, String model) {
		Response response = new Response();
		if (model == null || model.trim().isEmpty()) {
			response.setStatusCode(INVALID_DATA);
			response.setErrorMessage("Model cannot be empty");
